...
<link rel="stylesheet" href="Library-Menu.css" media="screen">
    ...
    <meta property="og:title" content="Library Menu">
    <meta property="og:type" content="website">
  <meta data-intl-tel-input-cdn-path="intlTelInput/"></head>
  <body data-path-to-root="./" data-include-products="true" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-custom-color-1 u-header u-sticky u-sticky-1d24 u-header" id="sec-462b"><div class="u-clearfix u-sheet u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-custom-color-3 u-text-custom-color-2 u-text-hover-custom-color-3" href="Library-Menu.php" style="padding: 22px 20px;">Library Menu</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Library-Menu.php">Library Menu</a>
        ...
        <a href="Home.html" class="u-image u-logo u-image-1" data-image-width="500" data-image-height="500">
          <img src="images/library.png" class="u-logo-image u-logo-image-1">
        </a>
      </div></header>
      <section class="u-align-center u-clearfix u-section-1" id="sec-873f">
        <div class="u-clearfix u-sheet u-sheet-1">
          <table class="u-table u-table-responsive u-table-1">
            <thead class="u-table-header u-white">
              <tr style="height: 50px;">
                <th class="u-table-cell">Product Image</th>
                <th class="u-table-cell">Product Title</th>
                <th class="u-table-cell">Price</th>
                <th class="u-table-cell">Add to Cart</th>
              </tr>
            </thead>
            <tbody class="u-table-body">
              <!-- Replace each product_item with a table row -->
              <?php
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        echo '<tr class="u-table-row">';
        echo '<td class="u-table-cell">';
        // echo '<a class="u-product-title-link" href="products/' . $row['title'] . '.html">';
        echo '<img alt="" class="u-expanded-width u-image u-image-contain u-image-default u-product-control u-image-1" src="upload/' . $row['picture'] . '">';
        echo '</a>';
        echo '</td>';
        echo '<td class="u-table-cell">';
        echo '<h4 class="u-product-control u-text u-text-1">';
        echo '<a class="u-product-title-link" href="products/' . $row['title'] . '.html">' . $row['title'] . '</a>';
        echo '</h4>';
        echo '</td>';
        echo '<td class="u-table-cell">';
        echo '<div class="u-product-control u-product-price u-product-price-1" data-add-zero-cents="false">';
        echo '<div class="u-price-wrapper u-spacing-10">';
        echo '<div class="u-price u-text-palette-2-base" style="font-size: 1.25rem; font-weight: 700;">' . $row['price'] . '</div>';
        echo '</div>';
        echo '</div>';
        echo '</td>';
        echo '<td class="u-table-cell">';
        echo '<a href="#" class="u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-1 u-dialog-link u-payment-button" data-product-button-click-type="buy-now" data-product-id="' . $row['BOOKID'] . '" data-product=\'{"id":"' . $row['BOOKID'] . '","name":"' . $row['title'] . '","title":"' . $row['title'] . '","description":"","price":"' . $row['price'] . '","oldPrice":"","quantity":1,"currency":"PHP","sku":"","outOfStock":false,"categories":[],"images":[{"url":"upload/' . $row['picture'] . '"}],"created":' . time() . ',"updated":' . time() . ',"isDefault":true,"categoriesData":[{"id":0,"title":"Uncategorized"}]}\'>';
        echo 'Add to Cart';
        echo '</a>';
        echo '</td>';
        echo '<td>';
        echo "<a href='Add.html?id={$row['BOOKID']}' class='btn btn-primary btn-sm'>Add</a> "."         ";
        echo "<a href='Edit.php?id={$row['BOOKID']}' class='btn btn-primary btn-sm'>Edit</a> "."         ";
        
        echo "<a href='deletebook.php?id={$row['BOOKID']}' class='btn btn-danger btn-sm'>Delete</a>"."         ";
        echo "</td>";
        echo '</tr>';
    }
} else {
...
?>
    ...
    <footer class="u-align-center u-clearfix u-custom-color-1 u-footer u-footer" id="sec-41a0"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <a href="https://nicepage.com" class="u-active-none u-btn u-btn-rectangle u-button-style u-hover-none u-none u-btn-1"><span class="u-icon"><svg class="u-svg-content" viewBox="0 0 405.333 405.333" x="0px" y="0px" style="width: 1em; height: 1em;"><path d="M373.333,266.88c-25.003,0-49.493-3.904-72.704-11.563c-11.328-3.904-24.192-0.896-31.637,6.699l-46.016,34.752    c-52.8-28.181-86.592-61.952-114.389-114.368l33.813-44.928c8.512-8.512,11.563-20.971,7.915-32.64    C142.592,81.472,138.667,56.96,138.667,32c0-17.643-14.357-32-32-32H32C14.357,0,0,14.357,0,32    c0,205.845,167.488,373.333,373.333,373.333c17.643,0,32-14.357,32-32V298.88C405.333,281.237,390.976,266.88,373.333,266.88z"></path></svg></span>&nbsp;+1 (234) 567-8910
        </a>
        <div class="u-align-left u-social-icons u-spacing-20 u-social-icons-1">
          <a class="u-social-url" title="facebook" target="_blank" href=""><span class="u-file-icon u-icon u-social-facebook u-social-icon u-icon-2"><img src="images/4922978.png" alt=""></span>
          </a>
          <a class="u-social-url" title="twitter" target="_blank" href=""><span class="u-file-icon u-icon u-social-icon u-social-twitter u-icon-3"><img src="images/1384174.png" alt=""></span>
          </a>
          <a class="u-social-url" title="instagram" target="_blank" href=""><span class="u-file-icon u-icon u-social-icon u-social-instagram u-icon-4"><img src="images/4923005.png" alt=""></span>
          </a>
          <a class="u-social-url" title="linkedin" target="_blank" href=""><span class="u-file-icon u-icon u-social-icon u-social-linkedin u-icon-5"><img src="images/1384171.png" alt=""></span>
          </a>
        </div>
  ...
  <section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-payment-dialog u-valign-middle u-dialog-section-4" id="sec-9469">
